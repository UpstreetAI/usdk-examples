...
export class AgentRenderer {
  ...
  constructor({
    ...
    const useCalendarKeysJson = () => {
      const calendarKeysJsonString = (env as any).CALENDER_KEYS_JSON as string;
      const calendarKeysJson = JSON.parse(calendarKeysJsonString);
      return calendarKeysJson;
    };
    const useWallets = () => {
    ...
    this.appContextValue = new AppContextValue({
      ...
      calendarKeysJson: useCalendarKeysJson(),
